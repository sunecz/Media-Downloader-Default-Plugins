...
public final class TVPrimaDomaEngine implements MediaEngine {
	...
	public ListTask<Media> getMedia(URI uri, Map<String, Object> data) throws Exception {
		return ListTask.of((task) -> {
			...
			JSONCollection videoList = OnNetwork.videoList(scriptSrc);
			...
			for(JSONCollection video : videoList.collectionsIterable()) {
	...
	private static final class OnNetwork {
		...
		public static final JSONCollection videoList(String url) throws Exception {
